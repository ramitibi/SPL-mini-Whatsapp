...
public class ConnectionAcceptor<T> {
	...
	protected WhatsappProtocol _manger;
	 ...
	 */
	public ConnectionAcceptor(ServerSocketChannel ssChannel, ReactorData<T> data, WhatsappProtocol manager) {
	...
	public void accept() throws IOException {
		...
		if (sChannel != null) {
			...
			ConnectionHandler<T> handler = ConnectionHandler.create(sChannel, _data, key , _manger);
